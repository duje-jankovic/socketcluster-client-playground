...
Playground to test websocketcluster client. Needs working socketcluster-server to connect to.

## Installation

- `$ yarn install`
- Create **.env** file and populate it according to **.example.env** file.
